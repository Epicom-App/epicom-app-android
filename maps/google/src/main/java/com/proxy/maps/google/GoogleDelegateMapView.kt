...
internal class GoogleDelegateMapViewClassName : DelegateMapViewClassName {
    override fun get(): String = GoogleDelegateMapView::class.java.name
}

@Keep
internal class GoogleDelegateMapView(
    context: Context,
    attributeSet: AttributeSet
) : GoogleMapView(context, attributeSet), DelegateMapView {
    ...
    override fun getMapAsyncDelegate(callback: OnMapReadyCallback) =
        getMapAsync { callback.onMapReady(GoogleMap(it)) }

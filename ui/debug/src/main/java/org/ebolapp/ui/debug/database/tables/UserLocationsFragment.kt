...
import org.ebolapp.presentation.debug.database.LocationsDbViewModel
...
class UserLocationsFragment : Fragment(R.layout.ui_debug_db_tableview_fragment) {

    private var binding: UiDebugDbTableviewFragmentBinding? = null
    private val viewModel by viewModel<LocationsDbViewModel>()
